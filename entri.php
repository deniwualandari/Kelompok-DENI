...
if( isset($_POST["submit"]) ) {
    ...
    ('', '$Peserta', '$Hari', '$Tanggal', '$Jam', '$Acara', '$Tempat', '$Keterangan')
    ";
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">AGEKA <sup>DINKES</sup></div>
      </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <h1> AGENDA  KEGIATAN DINAS KESEHATAN</h1>
        </nav>
        <!-- End of Topbar -->

        <!-- Begin Page Content -->
        <div style=" color: blue; font-style: italic" class="container-fluid">
        ...
        <tr>
            <td>
                <table>
                    ...
                    <tr>
                    <br>
                    <td style="color: black;">Peserta&emsp;&emsp;&nbsp;</td><td><input type="text" class="form-control" name="peserta" required autocomplete="off"></td>
                    <td style="color: black;">Hari&emsp;&emsp;&nbsp;</td><td><input type="text" class="form-control" name="hari"
                    required autocomplete="off">
                    </td>
                    <td style="color: black;">Tanggal&emsp;&emsp;&nbsp;</td><td><input type="date" class="form-control" name="tanggal" required  autocomplete="off"></td>
                   </br>
                    </tr>
                    <tr>
                      <td></td>
                    ...
                    <tr>
                    <td style="color: black;">Jam</td><td><input type="text" class="form-control" name="jam" required
                      autocomplete="off">
                    </td>
                    <td style="color: black;">Acara</td><td><input type="text" class="form-control" name="acara" required
                      autocomplete="off">
                    </td>
                    <td style="color: black;">Tempat</td><td><input type="text" class="form-control" name="tempat" required
                      autocomplete="off">
                    </td>
                ...
                <table>
                    <tr>
                      ...
                      <br>
                    <td style="color: black;">Keterangan&ensp;</td><td><input type="text" class="form-control" name="keterangan" 
                      size="90" required autocomplete="-">
                    </td>
</br>
                    </tr>
                </table>
                    ...
                    <button type="submit"  name="cancel"><a href="index.php">Batal</a></button>
                        </td>
                    </tr>
                    </form>
                </table>
