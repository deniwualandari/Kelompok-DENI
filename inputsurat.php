...
if( isset($_POST["submit"]) ) {
    ...
    $nomor_record = ($_POST["nomor_record"]);
    

    $query = "INSERT INTO surat_masuk VALUES
    ('', '$nomor_surat', '$dari', '$tanggal_surat', '$tanggal_terima', '$perihal', '$nomor_record')
    ";
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">SM <sup>DINKES</sup></div>
      </a>
            ...
            <div class="panel-body">
                <form method="POST">
                    ...
                    <div style=" color: blue; font-style: italic" class="form-group">
                        ...
                        <input type="date" class="form-control" name="tanggal_terima" placeholder="Masukkan tanggal terima ..">
                    </div>
                    <div style=" color: blue; font-style: italic" class="form-group">
                        <label>Perihal</label>
                    ...
                    <div style=" color: blue; font-style: italic" class="form-group">
                        ...
                        <input type="text" class="form-control" name="nomor_record" placeholder="Masukkan nomor record .." required="yes">
                    </div>
                    <br/>
